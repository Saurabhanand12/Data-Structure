// ///// IMPLEMENTATION OF MIN HEAP BY 1) COMPLETE BINARY TREE 2) MIN HEAP --ROOT ELEMENT VALUE IS MINIMUM AND ALL ANOTHER LEVEL ARE HIGH  VALUE IN CAMPARION of ROOT and VVIMP FOR INTERVIEW 
